...
require('./src/sockets/landingpage')(server);
...
//         const playerBeingVoted = isFirstRoundVoting?voteblePlayers[parseInt(voteIndex)].playerId:playersWithMostVotes[parseInt(voteIndex)].playerId;
